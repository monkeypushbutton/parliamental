package org.mpbsoftware.parliamental;
...
import org.mpbsoftware.parliamental.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("org.mpbsoftware.parliamental.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("org.mpbsoftware.parliamental.StartActivity");
